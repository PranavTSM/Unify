...
try:
    ...
    from mcp_server.models import GoogleCalendarEvent
except ImportError:
    # Handle potential path issues if run directly or structured differently
    logging.error("Could not import from mcp_server.calendar_actions or mcp_server.models. Ensure structure is correct.")
