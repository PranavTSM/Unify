...
try:
    from mcp_server.analysis import project_recurring_events, ProjectedEventOccurrence, analyze_busyness
except ImportError:
    logging.error("Could not import from mcp_server.analysis. Ensure structure is correct.")
